...
import com.burakoyke.travelbookapp.databinding.ActivityMapsBinding
import com.burakoyke.travelbookapp.model.Place
import com.burakoyke.travelbookapp.room.PlaceDao
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, GoogleMap.OnMapLongClickListener {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            sharedPreferences =
                getSharedPreferences("com.burakoyke.travelbookapp", MODE_PRIVATE)
            trackBoolean = false
            ...
            permissionLauncher =
                registerForActivityResult(ActivityResultContracts.RequestPermission()) { result ->
                    if (result) {
                        ...
                        //permission denied
                        Toast.makeText(this@MapsActivity, "Permisson needed!", Toast.LENGTH_LONG)
                            .show()
                    }
                }
        }
